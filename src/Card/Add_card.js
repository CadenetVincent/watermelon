...
export default class Add_Card extends React.Component {
    ...
    handleSubmit = e => {
        ...
        card.user_id = DataRequest.get_id_user_from_name(
            this.state.card_used.name
        );
        ...
        if (CardIsExist.length > 0) {
            this.setState({
                formErrors: {
                    ...this.state.formErrors,
                    is_exist: "This card already exists."
                }
            });
        } else if (this.state.allValid == true) {
            MaxUniqueId = Math.max.apply(
                Math,
                this.state.cardExist.map(function(item) {
                    return item.card_id;
                })
            );
            MaxUniqueId++;
                                    ...
                                    <Col xs={6}>
                                        <Form.Group className="label_form">
                                            ...
                                            <Form.Control
                                                ...
                                                required
                                                value={
                                                    this.state.card_used.number
                                                }
                                                onChange={
                                                    this.handleChangeCardUsed
                                                }
                                                onFocus={this.handleInputFocus}
                                            />
                                        </Form.Group>
