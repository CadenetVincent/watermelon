...
export default class Update_Card extends React.Component {
    constructor(props) {
        ...
        this.handleDateChangeCardUsed = this.handleDateChangeCardUsed.bind(
            this
        );
        this.handleTypeChangeCardUsed = this.handleTypeChangeCardUsed.bind(
            this
        );
    ...
    validateForm() {
        this.setState({
            allValid:
                this.state.formErrors.number == "ready" &&
    ...
    validateField(fieldName, value) {
        ...
        formErrors = DataRequest.validate_field_card(
            fieldName,
            value,
            formErrors
        );
    ...
    componentDidMount() {
        ...
        const card_used = DataRequest.get_card_by_card_id(
        ...
        if (card_used != "") {
            this.setState({
                card_used: {
                    ...
                    date: DataRequest.date_format_json_to_date(
                        card_used.card_expiration
                    ),
                ...
                expiry: DataRequest.date_format_json_to_date_picker(
                    card_used.card_expiration
                )
            });
        }
    ...
    handleDateChangeCardUsed = mydate => {
        var expiration = DataRequest.date_format_json_to_date_picker(
            DataRequest.date_to_date_format_json(mydate)
        );

        if (expiration == false) {
            mydate = new Date();
            expiration = DataRequest.date_format_json_to_date_picker(
                DataRequest.date_to_date_format_json(mydate)
            );
        }
    ...
    filteringChange = ({ target }) => {
        ...
        list_bank_name = list_bank_name.filter(function(item) {
            ...
            const compare_target = target.value
                .replace(/\s/g, "")
                .toLowerCase();
    ...
    handleSubmit = e => {
        ...
        const card_used = {
            ...
            card_expiration: DataRequest.date_to_date_format_json(
                this.state.card_used.date
            ),
    ...
    render() {
        ...
        const CardTypes = DataRequest.get_card_type_updated(
            this.props.match.params.id
        );
        ...
        return (
            <div className="container">
                ...
                {DataRequest.right_access_update_card(
                    this.props.match.params.id
                ) ? (
                    <Row>
