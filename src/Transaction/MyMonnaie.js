    ...
    handleSubmit(e) {
        ...
        if (this.state.deposit_error == "ready") {
            ...
            if (this.props.name == "money_deposit") {
                if (Alldeposit == undefined) {
                    ...
                    MaxUniqueId = Math.max.apply(
                        Math,
                        Alldeposit.map(function(item) {
                            return item.id_pay_out;
                        })
                    );
                    MaxUniqueId++;
                }
            ...
            if (this.props.name == "money_withdrawal") {
                ...
                const wallet_to_send = DataRequest.get_wallet_by_user_id(
                    user_id
                );
                ...
                if (wallet_to_send == false) {
                    ...
                    wallet_to_send[0].balance =
                        wallet_to_send[0].balance + obj.amount;
        ...
        return (
            <div>
                <h2 className="title_monnaie">
                    {this.props.name == "money_deposit" ? (
                        <p>Money Deposit</p>
                    ) : null}
                    {this.props.name == "money_transit" ? (
                        <p>Money Transit</p>
                    ) : null}
                    {this.props.name == "money_withdrawal" ? (
                        <p>Money Withdrawal</p>
                    ) : null}
                </h2>
                    ...
                    <Col xs={4}>
                        <Card style={{ height: "19rem" }}>
                            <Card.Body>
                                <Card.Title>
                                    {this.props.name == "money_deposit" ? (
                                        <p>Deposit your currency</p>
                                    ) : null}
                                    {this.props.name == "money_transit" ? (
                                        <p>Transit your currency</p>
                                    ) : null}
                                    {this.props.name == "money_withdrawal" ? (
                                        <p>Withdrawal your currency</p>
                                    ) : null}
                                </Card.Title>
                                ...
                                <Card.Text>
                                    {this.props.name == "money_deposit" ? (
                                        <p>
                                            Be careful not to find yourself in
                                            negative..
                                        </p>
                                    ) : null}
                                    {this.props.name == "money_transit" ? (
                                        <p>Recover your money now..</p>
                                    ) : null}
                                    {this.props.name == "money_withdrawal" ? (
                                        <p>
                                ...
                                <div className="panel panel-default panel_error">
                                    <FormErrors
                                        formErrors={[this.state.deposit_error]}
                                    />
                                </div>
                            </Card.Body>
                        </Card>
                                  ...
                                  <Card style={{ height: "16rem" }}>
                                      <Card.Body>
                                          ...
                                          <Card.Text>
                                              ...
                                              "money_withdrawal"
                                                  ? "From [wallet ID : " +
                                                    item.debited_wallet_id +
                                                    "] [Name : " +
                                                    DataRequest.get_user_name_from_wallet_id(
                                                        item.debited_wallet_id
                                                    ) +
                                                    "] has sent " +
                                                    item.amount / 100 +
                                                    " $ to [wallet ID : " +
                                                    item.credited_wallet_id +
                                                    "] [Name : " +
                                                    DataRequest.get_user_name_from_wallet_id(
                                                        item.credited_wallet_id
                                                    ) +
